(async function(){
  ...
  elBtnToday.addEventListener('click', (e)=>{
    e.preventDefault();
  ...
  elBtnPlanToday.addEventListener('click', (e)=>{
    e.preventDefault();
  ...
  elBtnDelivered.addEventListener('click', (e)=>{
    e.preventDefault();
  ...
  elBtnPack.addEventListener('click', (e)=>{
    e.preventDefault();
  ...
  btnCsv.addEventListener('click', (e)=>{
    if (btnCsv.classList.contains('disabled')) {
      e.preventDefault();
      return false;
    }
  });
